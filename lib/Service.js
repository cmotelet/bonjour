...
var Service = function (opts) {
  ...
  this.host = opts.host || os.hostname() + TLD
  this.port = opts.port
  this.fqdn = this.name + '.' + this.type + TLD
  this.subtypes = opts.subtypes || null
  this.txt = opts.txt || null
  this.publishArecord = (typeof opts.publishArecord === 'undefined') ? true : opts.publishArecord
  this.publishDnsSd = (typeof opts.publishDnsSd === 'undefined') ? true : opts.publishDnsSd
  this.cacheFlush = (typeof opts.cacheFlush === 'undefined') ? false : opts.cacheFlush
...
var proto = {
  ...
  _records: function () {
    ...
    if (this.publishDnsSd) {
      records.push(this._rrDnsSd())
    }
    if (this.publishArecord) {
